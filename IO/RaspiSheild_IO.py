...
# ================================================
# Solution Maker RPi-Sheild IO 32-Channel Port Expander
...
class IO :
  ...
  def __init__(self, address=0x20):
    #init object with i2c address, default is 0x20, 0x21, load default configuration, set all pins low and to output
