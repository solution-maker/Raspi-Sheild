...
# ================================================
# Solution Maker RPi-Sheild IO 32-Channel Port Expander - Interrupt Demo
...
# This example shows how to use the interrupt methods on the IO of RPi-Sheild.  
...
# Initialise the IO device using the default addresses and set the output of bank 1 on IC1 to the input of bank 1 on IC2
